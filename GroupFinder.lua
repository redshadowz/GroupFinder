...
-- "Yell" and "Channel" messages will only display if allowed.
	...
	GF_GetTypes(gsub(gsub(gsub(gsub(gsub(gsub(gsub(string.lower(arg1),".gg/%w+", ""), "|cff%w+|(%w+)[%d:]+|h", " %1 "), "|h|r", " "),"['']", ""),"any? ?1","anyone"),"some ?1","anyone"),"g2g","gtg"),showanyway)
...
end -- /script GF_CheckForGroups("","red","CHAT_MSG_SAY",true)

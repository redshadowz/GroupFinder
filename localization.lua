...
GF_TRIGGER_LIST = {
	...
	["IGNORE"] = { "channel", "lol", "lmao", "lmfao", "rofl", "stfu", "ignore", "noob", "website", "http", "progression", "friendship", "teamwork", "wants you",
	...
	["QUEST"] = {
		...
		["DUSTWALLOW"] 		= { 41, "test of skulls", "brood of onyxia", "morokk", "deadmire", },
		...
		["AQ40OPENING"] 	= { 60, "the isle of dread", "lakmaeran", "nightmares corruption", "decoy", "draconic", "wrath of neptulon", "maws", "eranikus", },
		["DUNGEON2"] 		= { 60, "alcaz island", "bloodkelp", },
